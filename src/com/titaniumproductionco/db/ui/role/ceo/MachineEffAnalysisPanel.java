...
public class MachineEffAnalysisPanel extends JPanel {
    private JTable table;
    private DateRangeSelector analyzeDates;
    private DoubleField errorField;

    public MachineEffAnalysisPanel() {
    ...
    public void updateTableModel(ActionEvent e) {
        ...
        successful = View.func_Analysis_MachineEfficiency.select("*", (rs) -> {
